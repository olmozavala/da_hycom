...
def main():
    ...
    weights_file = "/data/HYCOM/DA_HYCOM_TSIS/Training/0001_GoM2D_STDNORM_PERCOCEAN_0_NET_2DUNET_srfhgt_ssh-ssh-err-sst-sst-err_No-STD_OUT_SRFHGT_384x520/models/0001_GoM2D_STDNORM_PERCOCEAN_0_NET_2DUNET_srfhgt_ssh-ssh-err-sst-sst-err_No-STD_OUT_SRFHGT_384x520_2021_10_24_14_40-epoch-53-loss-0.00019910.hdf5"
    # Setting Network type (only when network type is UNET)
    name = '0001_GoM2D_STDNORM_PERCOCEAN_0_NET_2DUNET_srfhgt_ssh-ssh-err-sst-sst-err_No-STD_OUT_SRFHGT_384x520_2021_10_24_14_40-epoch-53-loss-0.00019910.hdf5'
    run_name = name
    ...
    # Setting obs vars
    obs_fields = ['ssh', 'ssh_err', 'sst', 'sst_err']
    ...
    print(F"Model's weight file: {weights_file}")
    # Set the name of the network
    config[TrainingParams.config_name] = run_name
    single_model(config)

def single_model(config):
