...
def get_training():
    cur_config = {
        ...
        ProjTrainingParams.YEARS: "2009_2010",
        # ProjTrainingParams.YEARS: "2002_2006",
...
def get_prediction_params():
    ...
    cur_config = {
        ...
        PredictionParams.output_folder: F"{join(_output_folder,'PredictionTestDataset')}",
        PredictionParams.output_imgs_folder: F"{join(_output_folder,'PredictionTestDataset','imgs')}",
